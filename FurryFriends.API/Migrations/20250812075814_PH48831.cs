    ...
    public partial class PH48831 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("22222222-2222-2222-2222-222222222222"), "Quản trị viên hệ thống", new DateTime(2025, 8, 12, 7, 58, 13, 890, DateTimeKind.Utc).AddTicks(5850), new DateTime(2025, 8, 12, 7, 58, 13, 890, DateTimeKind.Utc).AddTicks(5849), "admin", true });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("11111111-1111-1111-1111-111111111111"), null, null, new DateTime(2025, 8, 12, 7, 58, 13, 890, DateTimeKind.Utc).AddTicks(5754), "123456", true, "admin" });

            migrationBuilder.InsertData(
                table: "NhanViens",
                columns: new[] { "NhanVienId", "ChucVuId", "DiaChi", "Email", "GioiTinh", "HoVaTen", "NgayCapNhat", "NgaySinh", "NgayTao", "SDT", "TaiKhoanId", "TrangThai" },
                values: new object[] { new Guid("33333333-3333-3333-3333-333333333333"), new Guid("22222222-2222-2222-2222-222222222222"), "Hà Nội", "admin@furryfriends.local", "Nam", "Admin hệ thống", new DateTime(2025, 8, 12, 7, 58, 13, 890, DateTimeKind.Utc).AddTicks(5872), new DateTime(1990, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2025, 8, 12, 7, 58, 13, 890, DateTimeKind.Utc).AddTicks(5871), "0123456789", new Guid("11111111-1111-1111-1111-111111111111"), true });
