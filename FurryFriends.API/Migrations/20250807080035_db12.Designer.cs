<<<<<<<< HEAD:FurryFriends.API/Migrations/20250806143442_nmquan.Designer.cs
﻿// <auto-generated />
using System;
...
namespace FurryFriends.API.Migrations
{
    ...
    [Migration("20250806143442_nmquan")]
            ...
            modelBuilder.Entity("FurryFriends.API.Models.HinhThucThanhToan", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            HinhThucThanhToanId = new Guid("44444444-4444-4444-4444-444444444444"),
                            MoTa = "Khách hàng thanh toán tiền mặt khi nhận hàng",
                            TenHinhThuc = "Thanh toán khi nhận hàng (COD)"
                        },
                        new
                        {
                            HinhThucThanhToanId = new Guid("55555555-5555-5555-5555-555555555555"),
                            MoTa = "Chuyển khoản qua tài khoản ngân hàng",
                            TenHinhThuc = "Chuyển khoản ngân hàng"
                        },
                        new
                        {
                            HinhThucThanhToanId = new Guid("66666666-6666-6666-6666-666666666666"),
                            MoTa = "Thanh toán qua ví điện tử (Momo, ZaloPay, VNPay)",
                            TenHinhThuc = "Ví điện tử"
                        },
                        new
                        {
                            HinhThucThanhToanId = new Guid("77777777-7777-7777-7777-777777777777"),
            ...
            modelBuilder.Entity("FurryFriends.API.Models.ChucVu", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ChucVuId = new Guid("22222222-2222-2222-2222-222222222222"),
                            MoTaChucVu = "Quản trị viên hệ thống",
                            NgayCapNhat = new DateTime(2025, 8, 7, 8, 0, 34, 304, DateTimeKind.Utc).AddTicks(1532),
                            NgayTao = new DateTime(2025, 8, 7, 8, 0, 34, 304, DateTimeKind.Utc).AddTicks(1531),
                            TenChucVu = "admin",
                            TrangThai = true
                        });
                });
            ...
            modelBuilder.Entity("FurryFriends.API.Models.NhanVien", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            GioiTinh = "Nam",
                            HoVaTen = "Admin hệ thống",
                            NgayCapNhat = new DateTime(2025, 8, 7, 8, 0, 34, 304, DateTimeKind.Utc).AddTicks(1581),
                            NgaySinh = new DateTime(1990, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            NgayTao = new DateTime(2025, 8, 7, 8, 0, 34, 304, DateTimeKind.Utc).AddTicks(1581),
                            SDT = "0123456789",
                            TaiKhoanId = new Guid("11111111-1111-1111-1111-111111111111"),
                            TrangThai = true
                        });
            ...
            modelBuilder.Entity("FurryFriends.API.Models.TaiKhoan", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            TaiKhoanId = new Guid("11111111-1111-1111-1111-111111111111"),
                            NgayTaoTaiKhoan = new DateTime(2025, 8, 7, 8, 0, 34, 304, DateTimeKind.Utc).AddTicks(1329),
                            Password = "123456",
                            TrangThai = true,
                            UserName = "admin"
                        });
...
>>>>>>>> origin/Update:FurryFriends.API/Migrations/20250807080035_db12.Designer.cs
