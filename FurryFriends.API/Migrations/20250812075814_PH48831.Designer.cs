...
namespace FurryFriends.API.Migrations
{
    ...
    [Migration("20250812075814_PH48831")]
            ...
            modelBuilder.Entity("FurryFriends.API.Models.ChucVu", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            NgayCapNhat = new DateTime(2025, 8, 12, 7, 58, 13, 890, DateTimeKind.Utc).AddTicks(5850),
                            NgayTao = new DateTime(2025, 8, 12, 7, 58, 13, 890, DateTimeKind.Utc).AddTicks(5849),
                            TenChucVu = "admin",
                            TrangThai = true
                        });
                });
            ...
            modelBuilder.Entity("FurryFriends.API.Models.NhanVien", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            NgayCapNhat = new DateTime(2025, 8, 12, 7, 58, 13, 890, DateTimeKind.Utc).AddTicks(5872),
                            NgaySinh = new DateTime(1990, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            NgayTao = new DateTime(2025, 8, 12, 7, 58, 13, 890, DateTimeKind.Utc).AddTicks(5871),
                            SDT = "0123456789",
            ...
            modelBuilder.Entity("FurryFriends.API.Models.TaiKhoan", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            TaiKhoanId = new Guid("11111111-1111-1111-1111-111111111111"),
                            NgayTaoTaiKhoan = new DateTime(2025, 8, 12, 7, 58, 13, 890, DateTimeKind.Utc).AddTicks(5754),
                            Password = "123456",
                            TrangThai = true,
                            UserName = "admin"
                        });
