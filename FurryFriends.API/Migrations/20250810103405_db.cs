<<<<<<<< HEAD:FurryFriends.API/Migrations/20250816125317_nmq.cs
﻿using System;
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SoTienApDungToiThieu = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DiaChiGiaoHangId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ...
                    ThongTinVoucherLucMua = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DiaChiGiaoHangLucMua = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ThoiGianThayDoiTrangThai = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_HoaDons", x => x.HoaDonId);
                    table.ForeignKey(
                        name: "FK_HoaDons_DiaChiKhachHangs_DiaChiGiaoHangId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DotGiamGiaSanPhams_SanPhamChiTiets_SanPhamChiTietId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TenSanPhamLucMua = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    MoTaSanPhamLucMua = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ThuongHieuLucMua = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    KichCoLucMua = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    MauSacLucMua = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AnhSanPhamLucMua = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ChatLieuLucMua = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ThanhPhanLucMua = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_LichSuTrangThaiHoaDons_NhanViens_NhanVienId",
                        column: x => x.NhanVienId,
                        principalTable: "NhanViens",
                        principalColumn: "NhanVienId");
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("22222222-2222-2222-2222-222222222222"), "Quản trị viên hệ thống", new DateTime(2025, 8, 16, 12, 53, 15, 73, DateTimeKind.Utc).AddTicks(549), new DateTime(2025, 8, 16, 12, 53, 15, 73, DateTimeKind.Utc).AddTicks(409), "admin", true });

            migrationBuilder.InsertData(
                table: "HinhThucThanhToans",
                columns: new[] { "HinhThucThanhToanId", "MoTa", "TenHinhThuc" },
                values: new object[,]
                {
                    { new Guid("aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa"), "COD - Thanh toán tiền mặt khi nhận hàng", "Thanh toán khi nhận hàng" },
                    { new Guid("bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb"), "Thanh toán trực tuyến qua cổng thanh toán VNPay", "Thanh toán VNPay" }
                });

            migrationBuilder.InsertData(
                table: "TaiKhoans",
                columns: new[] { "TaiKhoanId", "KhachHangId", "NgayCapNhatCuoiCung", "NgayTaoTaiKhoan", "Password", "TrangThai", "UserName" },
                values: new object[] { new Guid("11111111-1111-1111-1111-111111111111"), null, null, new DateTime(2025, 8, 16, 12, 53, 15, 72, DateTimeKind.Utc).AddTicks(9929), "123456", true, "admin" });

            migrationBuilder.InsertData(
                table: "NhanViens",
                columns: new[] { "NhanVienId", "ChucVuId", "DiaChi", "Email", "GioiTinh", "HoVaTen", "NgayCapNhat", "NgaySinh", "NgayTao", "SDT", "TaiKhoanId", "TrangThai" },
                values: new object[] { new Guid("33333333-3333-3333-3333-333333333333"), new Guid("22222222-2222-2222-2222-222222222222"), "Hà Nội", "admin@furryfriends.local", "Nam", "Admin hệ thống", new DateTime(2025, 8, 16, 12, 53, 15, 73, DateTimeKind.Utc).AddTicks(1389), new DateTime(1990, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2025, 8, 16, 12, 53, 15, 73, DateTimeKind.Utc).AddTicks(1249), "0123456789", new Guid("11111111-1111-1111-1111-111111111111"), true });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DotGiamGiaSanPhams_SanPhamChiTietId",
                table: "DotGiamGiaSanPhams",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HoaDons_DiaChiGiaoHangId",
                table: "HoaDons",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LichSuTrangThaiHoaDons_NhanVienId",
                table: "LichSuTrangThaiHoaDons",
                column: "NhanVienId");
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TrangThai = table.Column<int>(type: "int", nullable: false),
                    GhiChu = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DiaChiGiaoHangId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    NhanVienId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_HoaDons_NhanViens_NhanVienId1",
            ...
            migrationBuilder.InsertData(
                table: "ChucVus",
                columns: new[] { "ChucVuId", "MoTaChucVu", "NgayCapNhat", "NgayTao", "TenChucVu", "TrangThai" },
                values: new object[] { new Guid("22222222-2222-2222-2222-222222222222"), "Quản trị viên hệ thống", new DateTime(2025, 8, 10, 10, 34, 4, 870, DateTimeKind.Utc).AddTicks(901), new DateTime(2025, 8, 10, 10, 34, 4, 870, DateTimeKind.Utc).AddTicks(900), "admin", true });

            migrationBuilder.InsertData(
                table: "TaiKhoans",
                columns: new[] { "TaiKhoanId", "KhachHangId", "NgayCapNhatCuoiCung", "NgayTaoTaiKhoan", "Password", "TrangThai", "UserName" },
                values: new object[] { new Guid("11111111-1111-1111-1111-111111111111"), null, null, new DateTime(2025, 8, 10, 10, 34, 4, 870, DateTimeKind.Utc).AddTicks(702), "123456", true, "admin" });

            migrationBuilder.InsertData(
                table: "NhanViens",
                columns: new[] { "NhanVienId", "ChucVuId", "DiaChi", "Email", "GioiTinh", "HoVaTen", "NgayCapNhat", "NgaySinh", "NgayTao", "SDT", "TaiKhoanId", "TrangThai" },
                values: new object[] { new Guid("33333333-3333-3333-3333-333333333333"), new Guid("22222222-2222-2222-2222-222222222222"), "Hà Nội", "admin@furryfriends.local", "Nam", "Admin hệ thống", new DateTime(2025, 8, 10, 10, 34, 4, 870, DateTimeKind.Utc).AddTicks(939), new DateTime(1990, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2025, 8, 10, 10, 34, 4, 870, DateTimeKind.Utc).AddTicks(939), "0123456789", new Guid("11111111-1111-1111-1111-111111111111"), true });
...
>>>>>>>> origin/BanHanglan1sua:FurryFriends.API/Migrations/20250810103405_db.cs
