...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FurryFriends.API.Models.ChucVu", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            NgayCapNhat = new DateTime(2025, 8, 25, 18, 42, 41, 823, DateTimeKind.Utc).AddTicks(8135),
                            NgayTao = new DateTime(2025, 8, 25, 18, 42, 41, 823, DateTimeKind.Utc).AddTicks(8134),
                            TenChucVu = "admin",
                            TrangThai = true
                        },
                        new
                        {
                            ...
                            NgayCapNhat = new DateTime(2025, 8, 25, 18, 42, 41, 823, DateTimeKind.Utc).AddTicks(8165),
                            NgayTao = new DateTime(2025, 8, 25, 18, 42, 41, 823, DateTimeKind.Utc).AddTicks(8164),
                            TenChucVu = "nhanvien",
                            TrangThai = true
                        });
                });
            ...
            modelBuilder.Entity("FurryFriends.API.Models.HinhThucThanhToan", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            HinhThucThanhToanId = new Guid("aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa"),
                            MoTa = "COD - Thanh toán tiền mặt khi nhận hàng",
                            TenHinhThuc = "Thanh toán khi nhận hàng"
                        },
                        new
                        {
                            HinhThucThanhToanId = new Guid("bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb"),
            ...
            modelBuilder.Entity("FurryFriends.API.Models.HoaDon", b =>
                {
                    ...
                    b.Property<Guid?>("DiaChiGiaoHangId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<string>("DiaChiGiaoHangLucMua")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<DateTime?>("ThoiGianThayDoiTrangThai")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("FurryFriends.API.Models.NhanVien", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            NgayCapNhat = new DateTime(2025, 8, 25, 18, 42, 41, 823, DateTimeKind.Utc).AddTicks(8207),
                            NgaySinh = new DateTime(1990, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            NgayTao = new DateTime(2025, 8, 25, 18, 42, 41, 823, DateTimeKind.Utc).AddTicks(8206),
                            SDT = "0123456789",
                        ...
                        new
                        {
                            ...
                            NgayCapNhat = new DateTime(2025, 8, 25, 18, 42, 41, 823, DateTimeKind.Utc).AddTicks(8237),
                            NgaySinh = new DateTime(1995, 5, 15, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            NgayTao = new DateTime(2025, 8, 25, 18, 42, 41, 823, DateTimeKind.Utc).AddTicks(8236),
                            SDT = "0987654321",
            ...
            modelBuilder.Entity("FurryFriends.API.Models.TaiKhoan", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            TaiKhoanId = new Guid("11111111-1111-1111-1111-111111111111"),
                            NgayTaoTaiKhoan = new DateTime(2025, 8, 25, 18, 42, 41, 823, DateTimeKind.Utc).AddTicks(8039),
                            Password = "123456",
                            TrangThai = true,
                            UserName = "admin"
                        },
                        ...
                        {
                            TaiKhoanId = new Guid("55555555-5555-5555-5555-555555555555"),
                            NgayTaoTaiKhoan = new DateTime(2025, 8, 25, 18, 42, 41, 823, DateTimeKind.Utc).AddTicks(8092),
                            Password = "123456",
                            TrangThai = true,
                            UserName = "nhanvien"
                        });
            ...
            modelBuilder.Entity("FurryFriends.API.Models.Voucher", b =>
                {
                    ...
                    b.Property<decimal?>("SoTienApDungToiThieu")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("FurryFriends.API.Models.HoaDon", b =>
                {
                    b.HasOne("FurryFriends.API.Models.DiaChiKhachHang", "DiaChiGiaoHang")
                        .WithMany()
